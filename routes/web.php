        ...
        Route::group(['middleware' => ['auth']], function() {
            ...
            //---------------------------------------------------
                ...
                //-----------------------------------------------------------
                        ...
                        Route::get('Print/Print_set_page_number/{Print}/{Review}', 'PrintController@Print_set_page_number')
                            ->name('Print.Print_set_page_number');
                ...
                //-----------------------------------------------------------
                        Route::get('Penelitian_terdahulu/Penelitian/{Penelitian}', 'Penelitian_terdahuluController@Penelitian')
                            ->name('Penelitian_terdahulu.Penelitian');
                        Route::get('Penelitian_terdahulu/{Penelitian_terdahulu}/deletedata', 'Penelitian_terdahuluController@deletedata')
                            ->name('Penelitian_terdahulu.deletedata');
                    Route::resource('Penelitian_terdahulu', Penelitian_terdahuluController::class);
                //-----------------------------------------------------------
                        Route::get('Dasar_teori/Penelitian/{Penelitian}', 'Dasar_teoriController@Penelitian')
                            ->name('Dasar_teori.Penelitian');
                        Route::get('Dasar_teori/{Dasar_teori}/deletedata', 'Dasar_teoriController@deletedata')
                            ->name('Dasar_teori.deletedata');
                    Route::resource('Dasar_teori', Dasar_teoriController::class);
                //-----------------------------------------------------------
            //---------------------------------------------------
        });
    //-----------------------------------------------------------

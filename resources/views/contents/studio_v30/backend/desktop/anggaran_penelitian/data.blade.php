                    ...
                    <table id="datatableDefaultx" class="table  ">
                        <thead class=" ">
                            <tr>
                                ...
                                <x-html.th-content-width title="Kategori" width="10%" />
                                ...
                                <x-html.th-content-width title="Total" width="10%" />
                                <x-html.th-content-width title="Act-10%" width="10%" />
                        ...
                        <tbody>
                            ...
                            @forelse ($Anggaran_penelitian as $row)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <?php
                                            $actual = $sub_harga - ($sub_harga * 10 / 100);
                                            $total_actual += $actual;
                                        ?>
